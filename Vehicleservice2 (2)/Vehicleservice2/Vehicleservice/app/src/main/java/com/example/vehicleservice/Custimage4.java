...
public class Custimage4 extends ArrayAdapter<String>  {
	...
	private String[] file;
	 ...
	 public Custimage4(Activity context, String[] file  ) {
	        //constructor of this class to get the values from main_activity_class

		 super(context, R.layout.cust_images4, file);
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
			...
			View listViewItem = inflater.inflate(R.layout.cust_images4, null, true);
			//cust_list_view is xml file of layout created in step no.2

			ImageView im = (ImageView) listViewItem.findViewById(R.id.imageView2);
